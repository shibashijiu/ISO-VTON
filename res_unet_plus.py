...
from DCA.utils.main_blocks import conv_block, ResConv, ASPP
from DCA.utils.main_blocks import SqueezeExciteBlock, AttentionBlock
from DCA.utils.dca import DCA
...
if __name__ == '__main__':
    ...
    def test(batchsize):
        device = 'cpu'
        in_channels = 3
        in1 = torch.rand(batchsize, in_channels, 512, 384).to(device=device)
